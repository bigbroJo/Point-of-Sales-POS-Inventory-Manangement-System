...
namespace BriteSparx_POS_System {
    ...
    public class ProductsByMonth2 : ReportClass {
        
        public ProductsByMonth2() {
        }
        
        public override string ResourceName {
            get {
                return "ProductsByMonth2.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "BriteSparx_POS_System.ProductsByMonth2.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedProductsByMonth2 : Component, ICachedReport {
        
        public CachedProductsByMonth2() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            ProductsByMonth2 rpt = new ProductsByMonth2();
            rpt.Site = this.Site;
            return rpt;
        }
